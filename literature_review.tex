...
\cite{guo2017calibration} provide a rigorous definition of perfect calibration and enumerate several calibration metrics for supervised multiclass classification.
