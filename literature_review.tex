...
In Platt and temperature scaling, a validation set is used to determine equation \ref{eqn:logistic_regression_platt_scaling}'s parameters $a$ and $b$ by optimizing its NLL. Importantly, the network's parameters and structure are always kept constant during this process.
